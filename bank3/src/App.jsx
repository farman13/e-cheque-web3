...
function App() {
  ...
  const connect = async () => {
    try {
      ...
      let contractAddress = "0x5A2333574C14f7844d354dC49acf3d3b477E5729";
  ...
  const handleIssueSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Cheque issued successfully!\n Contract Address : ${state.Contract.address}`);
    } catch (error) {
  ...
  return (
    <>
      <h1>Welcome to the CANARA Online Banking Portal !</h1>
